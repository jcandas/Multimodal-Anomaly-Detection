...
%% Process each band
band = 1;
blueestimate  = bandprocess(outputnew,band,sentpos,landsatpos);
band = 2;
greenestimate  = bandprocess(outputnew,band,sentpos,landsatpos);
band = 3;
redestimate  = bandprocess(outputnew,band,sentpos,landsatpos);
...
h = figure;
name = 'ReCalibration-Sentinel-Landsat';
